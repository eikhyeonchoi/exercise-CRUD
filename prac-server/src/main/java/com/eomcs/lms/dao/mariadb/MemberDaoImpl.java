...
public class MemberDaoImpl implements MemberDao {
  ...
  public void insert(Member member) {
    try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
      sqlSession.selectList("MemberMapper.insert", member);
      sqlSession.commit();
    }
  }
  ...
  public int update(Member member) {
    try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
      int isUpdate = sqlSession.update("MemberMapper.update", member);
      sqlSession.commit();
      return isUpdate;
    }
  }
  ...
  public int delete(int no) {
    try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
      int isDelete = sqlSession.delete("MemberMapper.delete", no);
      sqlSession.commit();
      return isDelete;
    }
  }
